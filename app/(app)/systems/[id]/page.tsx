...
function detailsBoxStyle(): CSSProperties {
  return {
...
function summaryStyle(): CSSProperties {
  return {
    listStyle: "none",
    cursor: "pointer",
    padding: "16px 18px",
...
export default async function BuildingSystemPage({
  ...
  const qrLabel =
    text(buildingSystem.qr_label, "") || `${labels.ar} - ${buildingName}`;
          ...
          <details style={detailsBoxStyle()}>
            ...
            >
              ...
              >
                ...
                {text(buildingSystem.building_system_id)}
              </div>
            </div>
          </details>
        </SectionCard>
